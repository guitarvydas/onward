...
Early electronic hardware strongly encouraged the use of a small number of characters.
Programming languages standardized on the use of ASCII, which limited the available number
of printable characters to about 96 possibilities.
...
\begin{figure}[h]
    \includegraphics[trim=1cm 2cm 1cm 1cm 1cm, clip, scale=0.4]{./media/main.png}
...
%  \begin{wrapfigure}{l}{0.8\textwidth}
  \begin{figure}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/drawio1.png}
    \caption{Raw .drawio}
    \label{drawio1}
%  \end{wrapfigure}
\end{figure}
...
\begin{figure}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/drawio2.png}
...
\begin{wrapfigure}{l}{0.4\textwidth}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/drawio3.png}
...
\begin{wrapfigure}{l}{0.8\textwidth}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/drawio4.png}
    \caption{reduced id}
    \label{drawio4}
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/json5.png}
...
%  \begin{wrapfigure}{l}{0.7\textwidth}
\begin{figure}[h]
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/ioports.png}
...
%  \begin{wrapfigure}{l}{0.4\textwidth}
\begin{figure}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/ioportsculled.png}
...
\begin{wrapfigure}{l}{0.7\textwidth}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/connection1.png}
...
\begin{wrapfigure}{r}{0.4\textwidth}
    \includegraphics[trim=1cm 2cm 1cm 1cm, clip, scale=0.4]{./media/connection2.png}
...
Compilation and execution of this DPL consists of the steps listed below.
 \begin{figure}[h]
    \centering
    \includegraphics[scale=0.5]{./media/full.png}
    \caption{DPL to executable code}
    \label{full}
 \end{figure}
...
\emph{programs} instead of as \emph{processes} in terms of efficiency because functions and closures are used instead of processes.
...
%% Rule of 7 ~ 
%% Parental Authority ~ 
%% Asynchronicity and time-relative ordering ~ 
...
%% Inferencing semantic information from diagrams using various techniques ~ 
%% Simple relations, like intersection, larger, smaller, above, below, left-of, right-of ~ 
%% Low-level concepts like loop ~  and recursion ~  don't make sense in a distributed environment ~ 
